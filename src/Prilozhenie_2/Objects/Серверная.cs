...
namespace IIS.Prilozhenie_2
{
    ...
    public class Серверная : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_2.Сотрудник fСотрудник;
        
        private IIS.Prilozhenie_2.DetailArrayOfКонтроллер fКонтроллер;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_2.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Prilozhenie_2.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Prilozhenie_2.DetailArrayOfКонтроллер Контроллер
        {
            get
            {
                ...
                {
                    this.fКонтроллер = new IIS.Prilozhenie_2.DetailArrayOfКонтроллер(this);
                }
                IIS.Prilozhenie_2.DetailArrayOfКонтроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СервернаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяE", typeof(IIS.Prilozhenie_2.Серверная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СервернаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяL", typeof(IIS.Prilozhenie_2.Серверная));
                }
            }
        }
    }

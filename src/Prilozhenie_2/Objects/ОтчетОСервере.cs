...
namespace IIS.Prilozhenie_2
{
    ...
    public class ОтчетОСервере : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_2.РежимСервера fРежим;
        
        private IIS.Prilozhenie_2.Расположение fРасположение;
        ...
        public virtual IIS.Prilozhenie_2.РежимСервера Режим
        {
            get
            {
                ...
                IIS.Prilozhenie_2.РежимСервера result = this.fРежим;
        ...
        [PropertyStorage(new string[] {
                "Расположение"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_2.Расположение Расположение
        {
            get
            {
                ...
                IIS.Prilozhenie_2.Расположение result = this.fРасположение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереE", typeof(IIS.Prilozhenie_2.ОтчетОСервере));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереL", typeof(IIS.Prilozhenie_2.ОтчетОСервере));
                }
            }
        }
    }
